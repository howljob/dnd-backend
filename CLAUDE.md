...
- **⚠️ В нумерации дыра: после `000018_campaigns_vtt_scenes.js` сразу `000024_tabletop_rooms_game_id.js`.** Файлов 19–23 нет. Причина не установлена. Не пытаться «восстановить» номера и не переиспользовать их без разбора ситуации с пользователем.
