...
const adminReportsRouter = require('./modules/admin-reports/admin-reports.routes');
const reportsRouter = require('./modules/reports/reports.routes');
const gameTransfersRouter = require('./modules/transfers/transfers.routes');
...
// T3.5: файловые аватары пользователей; T5.2: портреты персонажей
...
app.use('/api/games', gameTransfersRouter);
